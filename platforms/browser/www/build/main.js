...
var ViajesDestinoPage = (function () {
            ...
            return __generator(this, function (_f) {
                switch (_f.label) {
                    ...
                    case 1:
                        ...
                        _c = (_b = this.navCtrl).push;
                        _d = [__WEBPACK_IMPORTED_MODULE_4__home_c_view_ruta_home_c_view_ruta__["a" /* HomeCViewRutaPage */]];
                        _e = {};
                        return [4 /*yield*/, this.getLocation()];
                    case 2:
                        _c.apply(_b, _d.concat([(_e.origen_LatLngnvp = _f.sent(),
                                _e.destino_LatLngnvp = this.destino_LatLng,
                                _e.origen_direccionnvp = this.origen_direccion,
                                _e.destino_direccionnvp = this.destino_direccion,
                                _e)]));
                        return [2 /*return*/];
                }
            });
    ...
    ViajesDestinoPage.prototype.r_g_no_native = function (latlng) {
        var _this = this;
        var geocoder = new google.maps.Geocoder;
        geocoder.geocode({ 'location': latlng }, function (results, status) {
            if (status === 'OK') {

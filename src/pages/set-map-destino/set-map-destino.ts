...
@IonicPage()
@Component({
  selector: 'page-set-map-destino',
  templateUrl: 'set-map-destino.html',
})
export class SetMapDestinoPage {
  ...
  async loadMapa() {
    ...
    this.map = GoogleMaps.create('map_canvas5', mapOptions);//aqui le asigno el mapa este mapa se ve 
